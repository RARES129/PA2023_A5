...
/**
 * aici memoram coordonatele de la ambele capete ale drumului de tip Express
 */
public class Express {
    ...
    public boolean equals(Object o) {
        ...
        return X1 == express.X1 && X2 == express.X2 && Y1 == express.Y1 && Y2 == express.Y2;
    }
    /**
     *
     * @return returneaza un string cu toate informatiile din obiectul Express
     */
    @Override
    public String toString() {
        return "Express{" + "X1=" + X1 + ", X2=" + X2 + ", Y1=" + Y1 + ", Y2=" + Y2 + '}';
    }
}
